...
// .wrangler/tmp/bundle-z9j0cq/strip-cf-connecting-ip-header.js
...
var ChatSession = class extends DurableObject {
      ...
      try {
        ...
        const inputArgs = {
          messages: [
            {
              role: "system",
              content: "You are a senior Linux Network Engineer. Help the user debug SSH, DNS, and Firewall issues. Be concise. You are 'HomeLab Helper'."
            },
            ...this.messages
          ]
        };
...
// .wrangler/tmp/bundle-z9j0cq/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-z9j0cq/middleware-loader.entry.ts
